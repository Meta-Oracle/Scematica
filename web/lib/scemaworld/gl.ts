...
export function createRenderer(canvas: HTMLCanvasElement): Renderer {
  ...
  const WIRES: Record<string, () => Mesh.Wire> = {
    ...
    corvette: Mesh.corvette,
    marauder: Mesh.marauder,
    cruiser: Mesh.cruiser,
    bulwark: Mesh.bulwark,
    sovereign: Mesh.sovereign,
    raiderSkiff: Mesh.raiderSkiff,
    raiderLancer: Mesh.raiderLancer,
    frigate: Mesh.frigate,
    destroyer: Mesh.destroyer,
    warfighter: Mesh.warfighter,
    leviathan: Mesh.leviathan,
    titan: Mesh.titan,
    courier: Mesh.courier,
    freighter: Mesh.freighter,
    marshal: Mesh.marshal,
    warden: Mesh.warden,
    bastion: Mesh.bastion,
    skiff: Mesh.skiff,
    dart: Mesh.dart,
    lance: Mesh.lance,
    prowler: Mesh.prowler,
    halberd: Mesh.halberd,
    rampart: Mesh.rampart,
    aegis: Mesh.aegis,
    carrack: Mesh.carrack,
    monitor: Mesh.monitor,
    vanguard: Mesh.vanguard,
    suzerain: Mesh.suzerain,
    dominion: Mesh.dominion,
  ...
  const groups: Record<Shape, Group> = {
    ...
    corvette: group(wireProg, WIRES.corvette(), gl.LINES, 'aFlash'),
    marauder: group(wireProg, WIRES.marauder(), gl.LINES, 'aFlash'),
    cruiser: group(wireProg, WIRES.cruiser(), gl.LINES, 'aFlash'),
    bulwark: group(wireProg, WIRES.bulwark(), gl.LINES, 'aFlash'),
    sovereign: group(wireProg, WIRES.sovereign(), gl.LINES, 'aFlash'),
    raiderSkiff: group(wireProg, WIRES.raiderSkiff(), gl.LINES, 'aFlash'),
    raiderLancer: group(wireProg, WIRES.raiderLancer(), gl.LINES, 'aFlash'),
    frigate: group(wireProg, WIRES.frigate(), gl.LINES, 'aFlash'),
    destroyer: group(wireProg, WIRES.destroyer(), gl.LINES, 'aFlash'),
    warfighter: group(wireProg, WIRES.warfighter(), gl.LINES, 'aFlash'),
    leviathan: group(wireProg, WIRES.leviathan(), gl.LINES, 'aFlash'),
    titan: group(wireProg, WIRES.titan(), gl.LINES, 'aFlash'),
    courier: group(wireProg, WIRES.courier(), gl.LINES, 'aFlash'),
    freighter: group(wireProg, WIRES.freighter(), gl.LINES, 'aFlash'),
    marshal: group(wireProg, WIRES.marshal(), gl.LINES, 'aFlash'),
    warden: group(wireProg, WIRES.warden(), gl.LINES, 'aFlash'),
    bastion: group(wireProg, WIRES.bastion(), gl.LINES, 'aFlash'),
    skiff: group(wireProg, WIRES.skiff(), gl.LINES, 'aFlash'),
    dart: group(wireProg, WIRES.dart(), gl.LINES, 'aFlash'),
    lance: group(wireProg, WIRES.lance(), gl.LINES, 'aFlash'),
    prowler: group(wireProg, WIRES.prowler(), gl.LINES, 'aFlash'),
    halberd: group(wireProg, WIRES.halberd(), gl.LINES, 'aFlash'),
    rampart: group(wireProg, WIRES.rampart(), gl.LINES, 'aFlash'),
    aegis: group(wireProg, WIRES.aegis(), gl.LINES, 'aFlash'),
    carrack: group(wireProg, WIRES.carrack(), gl.LINES, 'aFlash'),
    monitor: group(wireProg, WIRES.monitor(), gl.LINES, 'aFlash'),
    vanguard: group(wireProg, WIRES.vanguard(), gl.LINES, 'aFlash'),
    suzerain: group(wireProg, WIRES.suzerain(), gl.LINES, 'aFlash'),
    dominion: group(wireProg, WIRES.dominion(), gl.LINES, 'aFlash'),
