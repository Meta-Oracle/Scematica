...
export const HITBOX: Record<Shape, Mesh.Bounds> = {
  ...
  cruiser: Mesh.boundsOf(Mesh.cruiser()),
  bulwark: Mesh.boundsOf(Mesh.bulwark()),
  sovereign: Mesh.boundsOf(Mesh.sovereign()),
  raiderSkiff: Mesh.boundsOf(Mesh.raiderSkiff()),
  raiderLancer: Mesh.boundsOf(Mesh.raiderLancer()),
  frigate: Mesh.boundsOf(Mesh.frigate()),
  destroyer: Mesh.boundsOf(Mesh.destroyer()),
  warfighter: Mesh.boundsOf(Mesh.warfighter()),
  leviathan: Mesh.boundsOf(Mesh.leviathan()),
  titan: Mesh.boundsOf(Mesh.titan()),
  courier: Mesh.boundsOf(Mesh.courier()),
  freighter: Mesh.boundsOf(Mesh.freighter()),
  marshal: Mesh.boundsOf(Mesh.marshal()),
  warden: Mesh.boundsOf(Mesh.warden()),
  bastion: Mesh.boundsOf(Mesh.bastion()),
  skiff: Mesh.boundsOf(Mesh.skiff()),
  dart: Mesh.boundsOf(Mesh.dart()),
  lance: Mesh.boundsOf(Mesh.lance()),
  prowler: Mesh.boundsOf(Mesh.prowler()),
  halberd: Mesh.boundsOf(Mesh.halberd()),
  rampart: Mesh.boundsOf(Mesh.rampart()),
  aegis: Mesh.boundsOf(Mesh.aegis()),
  carrack: Mesh.boundsOf(Mesh.carrack()),
  monitor: Mesh.boundsOf(Mesh.monitor()),
  vanguard: Mesh.boundsOf(Mesh.vanguard()),
  suzerain: Mesh.boundsOf(Mesh.suzerain()),
  dominion: Mesh.boundsOf(Mesh.dominion()),
