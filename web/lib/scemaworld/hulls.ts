...
export const HULLS: Record<HullId, HullSpec> = {
  ...
  skiff: {
    ...
    armour: 1, shields: 1, speed: 1, tanks: 1, guns: 1, jump: 0, price: 0,
  },
  ...
  scout: {
    ...
    armour: 0.7, shields: 0.9, speed: 1.5, tanks: 1.8, guns: 0.9, jump: 2, price: 400,
  },
  // The all-rounder, and the one most people should buy first.
  corvette: {
    id: 'corvette', label: 'CORVETTE', note: 'no weakness and no speciality',
    armour: 1.6, shields: 1.5, speed: 1.15, tanks: 1.2, guns: 1.2, jump: 1, price: 900,
  },
  ...
  lancer: {
    ...
    armour: 2.2, shields: 2.6, speed: 0.92, tanks: 1, guns: 1.7, jump: 1, price: 2200,
  },
  ...
  marauder: {
    ...
    armour: 4.5, shields: 4.2, speed: 0.8, tanks: 1.6, guns: 2.1, jump: 2, price: 6500,
  },
}
